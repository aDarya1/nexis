        ...
        <form onSubmit={handleSearch} className="flex-1 max-w-2xl mx-8">
          <div className="relative group">
            ...
            <input
              ...
              className={cn(
                "w-full pl-12 pr-20 py-3 border rounded-xl focus:outline-none transition-all",
                "bg-background border-border text-foreground focus:ring-2 focus:ring-ring",
              )}
            />
            {/* Clear Button (X) */}
            {searchValue && (
                ...
                <div className="relative" ref={userMenuRef}>
                  <div className="w-8 h-8 rounded-full overflow-hidden border-2 cursor-pointer hover:scale-110 transition-transform border-primary">
                    <img
                      src={
                        user?.avatar ||
                        "https://api.dicebear.com/7.x/avataaars/svg?seed=Nexis"
                      }
                      alt={user?.name || "User"}
                  ...
                  {showUserMenu && (
                    <div
                      className={cn(
                        "absolute right-0 top-full mt-2 w-56 rounded-lg border shadow-lg overflow-hidden z-50",
                        "bg-popover border-border",
                      )}
                    >
                      <div className="p-3 border-b border-border">
